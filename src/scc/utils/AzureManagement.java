...
public class AzureManagement {
	...
	static final String MY_SUFFIX = "groupdrt"; // Add your suffix here
	...
	static final String[] AZURE_FUNCTIONS_NAME = Arrays.stream(REGIONS)
			.map(reg -> "scc2223fun" + reg.name() + MY_SUFFIX)
			.toArray(String[]::new);
